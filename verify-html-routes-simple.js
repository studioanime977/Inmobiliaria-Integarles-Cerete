// Script simplificado para verificar rutas de imágenes en index.html
...
try {
  ...
  // Extraer todas las rutas de imágenes del HTML usando regex
  ...
  while ((match = hrefRegex.exec(htmlContent)) !== null) {
    // Filtrar solo enlaces que apunten a archivos locales (no URLs externas ni anclas)
